...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<p>
		<label for="group-notifiy-members"><?php _e( 'Notify Committee members of changes via email', 'buddypress' ); ?></label>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<div class="radio">
		<label>
			...
			<ul>
				...
				<li><?php _e( 'This group will be listed in the committees directory and in search results.', 'buddypress' ) ?></li>
		...
		<label>
			...
			<ul>
				...
				<li><?php _e( 'Committee content and activity will only be visible to members of the group.', 'buddypress' ) ?></li>
			</ul>
		</label>
		...
		<label>
			...
			<ul>
				...
				<li><?php _e( 'This Committee will not be listed in the Committees directory or search results.', 'buddypress' ) ?></li>
	...
	<h4><?php _e( 'Committee Invitations', 'buddypress' ); ?></h4> 
