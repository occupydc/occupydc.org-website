...
<div class="">
	...
	<?php else : ?>
		...
		<form name="login-form" id="sidebar-login-form" class="standard-form" action="../<?php echo site_url( 'wp-login.php', 'login_post' ) ?>" method="post">
			...
			<table><tbody><tr><td style="border: 0px !important;width: 122px;"><p class="forgetmenot"><label><input name="rememberme" type="checkbox" id="sidebar-rememberme" value="forever" tabindex="99" /> <?php _e( 'Remember Me', 'buddypress' ) ?></label></p></td><td style="border: 0px !important;">
			<?php do_action( 'bp_sidebar_login_form' ) ?>
			<input type="submit" name="wp-submit" id="sidebar-wp-submit" value="<?php _e( 'Log In', 'buddypress' ); ?>" tabindex="100" />
			<input type="hidden" name="testcookie" value="1" /></td></tr></tbody></table>
		</form>
