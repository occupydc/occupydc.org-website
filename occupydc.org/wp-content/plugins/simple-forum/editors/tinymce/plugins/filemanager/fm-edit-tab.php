...
<th><a href="fm-edit-tab.php?type=<?php echo $typenow.$passaction.$passfolder.$sortbyget['name']; ?>"<?php echo $thclass['name']; ?>><?php echo FM_FILENAME; ?></a></th>
<th><a href="fm-edit-tab.php?type=<?php echo $typenow.$passaction.$passfolder.$sortbyget['size']; ?>"<?php echo $thclass['size']; ?>><?php echo FM_SIZE; ?></a></th>
<th><a href="fm-edit-tab.php?type=<?php echo $typenow.$passaction.$passfolder.$sortbyget['type']; ?>"<?php echo $thclass['type']; ?>><?php echo FM_TYPE; ?></th>
