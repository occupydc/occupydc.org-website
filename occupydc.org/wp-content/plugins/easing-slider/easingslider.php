...
<?php  }
	...
	if ($shadow=='')   
	echo '<img src="'.WP_PLUGIN_URL.'/easing-slider/images/shadow_'.$shadowstyle.'.png" style="width:'.$width.'px; padding-left:'.$padleft.'px;padding-bottom:'.$padding.'px;padding-top:'.$padtop.'px;margin-left:'.$bwidth.';" alt="" />'; ?><!-- End of Easing Slider --><?php
